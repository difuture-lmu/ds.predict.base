...
It is necessary to register the assign methods in the OPAL administration to use them. The assign methods are:

- `decodeBinary`
- `assignPredictModel`

These methods should be registered automatically when publishing the package on OPAL (see `DESCRIPTION`).
